...
**PraiseCards** is a ServiceNow application I built for peer recognition. Employees send collectible recognition cards through the Service Catalog; after approval, recipients see them on a Service Portal page (**My Cards** / **All Cards**).

| | |
|---|---|
| **Product** | PraiseCards |
| **Developer** | Alishba Khan |
| **Platform** | ServiceNow Catalog · Flow · Service Portal |
| **Portal** | `/sp?id=praise-cards` |
| **Live** | https://dev390713.service-now.com/sp?id=praise-cards |
...
**PraiseCards** gives every employee a simple way to send a recognition card to a colleague — a proper collectable on the Now Platform, not just a chat message that gets buried.
...
Alishba Khan — Cloud Analogy

Recognition experience on ServiceNow: Catalog, Flow Designer, Script Include, and Service Portal.
